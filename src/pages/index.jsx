...
export default function HomePage() {
	...
	useEffect(() => {
		...
		historyService.getEventsByDate(yesterdayMonth, yesterdayDay).then(events => {
			if (events && events.length > 0) {
	...
	return (
		<div className="relative min-h-screen pt-12">
			...
			════════════════════════════════════════════════════════════════ */}
			<section id="todays-chronicle" className="w-full pt-2 pb-8 md:pt-2 md:pb-12 px-4 md:px-8 flex flex-col items-center">
							...
							<div className="relative z-10 flex flex-col items-center text-center space-y-5">
								...
								<div className="flex flex-col items-center">
									...
									<h1 className="text-5xl md:text-7xl font-display text-gold-muted text-shadow-vintage leading-none">
										History<br /><span className="text-3xl md:text-5xl text-paper opacity-90 block mt-2">of the Day</span>
									</h1>
								</div>
